    ...
    return (
        <div className='min-h-[100vh] flex items-center justify-center'>
            <div className="container_wrapper container_padding">
                ...
                <div className="flex justify-center items-center sm:p-10 p-10 sm:p-10 p-10 sm:px-10 px-3">

                    <div className="content mr-[1.5rem]">
                        <img src={KeyIcon} alt="" />
                    </div>
                    <div className="content">
                        <p className='text-base text-copy font-display select-auto'>We use advanced data protection to ensure your
                            <br />
                            personal and financial details are kept safe.</p>
                    </div>
                </div>
